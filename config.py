...
OWNER_ID = int(getenv("OWNER_ID", "1410065122"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ALASSUPORT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ALASSUPORT")
